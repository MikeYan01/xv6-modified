...
Part 3:
Retrieving multiple items from hash table does not require lock,
unless we insert and retrieve at the same time.

Part 4:
We could use a lock[NUM_BUCKETS] array to solve this.
*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
/********** Q1, 4 Modify Begin **********/
pthread_mutex_t lock[NUM_BUCKETS]; // declare lock
/********** Q1, 4 Modify End **********/
...
// Entries can get lost here without lock
// The overheads make inserting longer than before.
...
/*
For Q3:
Mutex lock is not necessary here.
However, it is useful when reading and writing are executing at the same time.
*/
